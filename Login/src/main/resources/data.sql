INSERT INTO `movies` (`movie_name`, `genre`, `poster_url`, `base_cost`, `cast`, `description`, `duration`)
VALUES
("No man's land",
"Action",
...
INSERT INTO `theater` (`theater_name`, `a_section`, `b_section`, `vip_section`, `address`, `image_url`, `description`)
VALUES
